...
function AboutMeSection() {
    ...
    const getDelay = (index) => {
        switch (index) {
            case 0:
                return 0;   // Primeira animação
            case 2:
                return 200; // Segunda animação
            case 1:
                return 400; // Terceira animação
            case 3:
                return 600; // Quarta animação
            case 4:
                return 800; // Última animação
            default:
                return 0;
        }
    };
                    ...
                    <div>
                        ...
                        <div>
                            <div>
                                {boxTopicos.slice(0, 2).map((topico, index) => (
                                    ...
                                    >
                                        <ContentBlock title={topico.title} description={topico.description}
                            ...
                            <div>
                                {boxTopicos.slice(2, 4).map((topico, index) => (
                                    <div
                                        ...
                                        style={{
                                            opacity: visibleIndices.includes(index + 2) ? 1 : 0,
                                            transition: 'opacity 0.5s ease-in-out'
                                        }}
                                    >
                                        <ContentBlock title={topico.title} description={topico.description}
                        ...
                        <div className={styles.centralizedContent}>
                            <div
                                ...
                                style={{
                                    opacity: visibleIndices.includes(4) ? 1 : 0,
                                    transition: 'opacity 0.5s ease-in-out'
                                }}
                            >
